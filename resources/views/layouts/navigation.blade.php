            ...
            @if (Auth::user()->role == 0)
                <li>
                    ...
                    <ul id="systemDd" class="hidden py-2 space-y-2">
                        ...
                        {{-- <li>
                            <a href="{{ route('models') }}" class="flex items-center w-full p-2 text-gray-600 transition duration-75 rounded-lg hover:text-gray-700 pl-11 group hover:bg-gray-200">Models</a>
                        </li> --}}
                    </ul>
                </li>
            @endif
