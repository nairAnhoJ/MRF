                        ...
                        <div id="tab1" class="w-1/4 h-full mr-4 space-y-4 overflow-x-hidden overflow-y-auto">
                            ...
                            <div class="flex gap-x-4">
                                <div class="w-full">
                                    ...
                                    <select id="for" name='for' class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                                        ...
                                        <option value="FOR PM" {{ ($nc_request->for == 'FOR PM') ? 'selected' : '' }}>For PM</option>
                                        <option value="FOR REPAIR" {{ ($nc_request->for == 'FOR REPAIR') ? 'selected' : '' }}>For Repair</option>
                                    </select>
                                    @error('for')
                                ...
                                <div class="w-full">
                                    ...
                                    <select id="order_type" name='order_type'" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                                        ...
                                        <option value="IN STOCK" {{ ($nc_request->order_type == 'IN STOCK') ? 'selected' : '' }}>In Stock</option>
                                        <option value="REQUEST PARTS" {{ ($nc_request->order_type == 'REQUEST PARTS') ? 'selected' : '' }}>Request Parts</option>
                                    </select>
                                    @error('order_type')
                                        <span class="text-xs text-red-500">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="w-full">
                                    ...
                                    <input type="date" name='date_needed' id="date_needed" value="{{ $nc_request->date_needed }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                                    @error('date_needed')
                                        <span class="text-xs text-red-500">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative w-full wrapper">
                                    <div class="flex items-center justify-between p-2.5 border border-gray-300 rounded-md cursor-pointer bg-gray-50 select-btn h-[42px]">
                                        <span id="customer_name">{{ $nc_request->customer_name }}</span>
                                    ...
                                    <input type="hidden" name='customer_name' value="{{ $nc_request->customer_name }}">
                                </div>
                                @error('customer_name')
                                    <span class="text-xs text-red-500">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="flex gap-x-4">
                                <div class="w-full">
                                    ...
                                    <input type="text" id="customer_address" name='customer_address' value="{{ $nc_request->customer_address }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" readonly>
                                ...
                                <div class=" w-96">
                                    ...
                                    <input type="text" id="customer_area" name='customer_area' value="{{ $nc_request->customer_area }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" readonly>
                                    @error('customer_area')
                                        <span class="text-xs text-red-500">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="flex gap-x-4">
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="relative w-full wrapper">
                                        <div id="modelSelect" class="flex items-center justify-between p-2.5 border border-gray-300 rounded-md bg-gray-50  h-[42px] select-btn cursor-pointer">
                                            <span id="model">{{ $nc_request->model }}</span>
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-full text-gray-700 transition-transform duration-300" viewBox="0 -960 960 960" fill='currentColor'><path d="M480-322 216-586l67-67 197 198 197-197 67 67-264 263Z"/></svg>
                                        </div>
                                        <div class="absolute z-50 hidden w-full p-3 mt-1 border border-gray-300 rounded-md bg-gray-50 content">
                                            <div class="relative search">
                                        ...
                                        <input type="hidden" name='model' value="{{ $nc_request->model }}">
                                    </div>
                                    @error('model')
                                        <span class="text-xs text-red-500">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="w-full">
                                    ...
                                    <input type="text" id="serial_number" name='serial_number' value="{{ $nc_request->serial_number }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" autocomplete="off">
                                    @error('serial_number')
                                        <span class="text-xs text-red-500">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="flex gap-x-4">
                                <div class="w-full">
                                    ...
                                    <input type="text" id="fsrr_number" name='fsrr_number' value="{{ $nc_request->fsrr_number }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" autocomplete="off">
                                    @error('fsrr_number')
                                        <span class="text-xs text-red-500">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="w-full">
                                    ...
                                    <div class="flex gap-x-2">
                                        <input type="file" id='fsrrFile' name="fsrrFile" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" accept=".jpeg, .jpg, .png, .pdf">
                                        <button type="button" id='viewFsrrButton' class="disabled:pointer-events-none disabled:opacity-60 h-[42px] bg-gray-100 border rounded-lg border-gray-300 aspect-square p-[6px] text-gray-700">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill=currentColor>
                                ...
                                <div class="w-full">
                                    ...
                                    <select id="delivery_type" name='delivery_type' class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                                        <option value="" hidden>Select Order Type</option>
                                        <option value="REGULAR" {{ ($nc_request->delivery_type == 'REGULAR') ? 'selected' : '' }}>Regular</option>
                                        <option value="SAME DAY" {{ ($nc_request->delivery_type == 'SAME DAY') ? 'selected' : '' }}>Same Day</option>
                                        <option value="PICKUP" {{ ($nc_request->delivery_type == 'PICKUP') ? 'selected' : '' }}>Pick Up</option>
                                        <option value="AIR" {{ ($nc_request->delivery_type == 'AIR') ? 'selected' : '' }}>Air</option>
                                        <option value="SEA" {{ ($nc_request->delivery_type == 'SEA') ? 'selected' : '' }}>Sea</option>
                                        <option value="OTHERS" {{ ($nc_request->delivery_type == 'OTHERS') ? 'selected' : '' }}>Others</option>
                                    </select>
                                    @error('delivery_type')
                                        <span class="text-xs text-red-500">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="w-full">
                                ...
                                <textarea style="resize: none;" id='requestor_remarks' name='requestor_remarks' class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 h-32" autocomplete="off">{{ $nc_request->requestor_remarks }}</textarea>
                            </div>
