                ...
                <div class="h-full">
                    {{-- ADD USER --}}
                        @if (Auth::user()->role == 1 || Auth::user()->role == 2)
                            <a href="{{ route('nchargeable.add') }}" class="flex items-center h-full px-8 text-lg font-bold text-white bg-blue-500 rounded-lg">ADD</a>
                        @endif
                    {{-- ADD USER --}}
                </div>
                    {{-- SEARCH --}}
                        <form action="{{ route('nchargeable') }}" method="GET" class="w-96">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="search" name="search" value="{{ $search }}" class="block w-full p-4 text-sm text-gray-900 border border-gray-300 rounded-lg !pl-9 bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Search...">
